...
export const routes: Routes = [
  ...
  { path: 'login', component: Login },
  {
    path: '', component: MainLayout, canActivate: [authGuard], children: [
      { path: 'dashboard', component: Dashboard, canActivate: [permissionGuard('dashboard.ver')] },
      { path: 'viajes/nuevo', component: CapturaViaje, canActivate: [permissionGuard('viajes.crear')] },
      { path: 'viajes/bitacora', component: BitacoraSemanal, canActivate: [permissionGuard('viajes.ver')] },
      { path: 'resumenes', component: ResumenMaterial, canActivate: [permissionGuard('resumenes.ver')] },
      { path: 'pagos', component: SellosPagos, canActivate: [permissionGuard('pagos.registrar')] },
      { path: 'corte', component: CorteSemanal, canActivate: [permissionGuard('cortes.ver')] },
      { path: 'catalogos', component: Catalogos, canActivate: [permissionGuard('catalogos.ver')] },
